...
{
    public class StudentGetAllHandler : IRequestHandler<StudentGetAllQuery, List<StudentViewModel>>
    {
        private readonly IStudentRepository _studentRepository;
        public StudentGetAllHandler(IStudentRepository studentRepository)
        {
            _studentRepository = studentRepository;
        }
        public async Task<List<StudentViewModel>> Handle(StudentGetAllQuery request, CancellationToken cancellationToken)
        {
            try
            {
